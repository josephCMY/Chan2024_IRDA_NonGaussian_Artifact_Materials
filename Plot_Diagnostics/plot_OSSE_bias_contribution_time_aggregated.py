...
exptlist = ['FCSTCLOUD','FCSTCLOUD+RAOEI','FCSTCLOUD+AOEI']
...
# Colors
expt_style_dict = {
    'NoAOEI_NoCloudUpdate': {'color':'k','style':'-'},
    'gAOEI_NoCloudUpdate': {'color':'dodgerblue','style':'-'},
    'NoCloudUpdate':  {'color':'r','style':'-'}
}
