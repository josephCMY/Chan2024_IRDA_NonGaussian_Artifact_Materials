'''
Script to plot out evolution of bias contributions
'''
...
ax_inno.set_title('d) Domain-averaged Innovation of '+expt, loc='left')




# Label figuew, v
plt.suptitle( 'Evolution of Biases for %s' % ( expt ) ) 
  

# Save figure
plt.savefig('figs/bias_evolution_%s.pdf' % (expt ))
plt.close()
