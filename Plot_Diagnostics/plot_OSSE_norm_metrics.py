...
for ss in stagelist:
  ...
  plt.suptitle( "%s's %s-relative RMSEs (left)\n and %s's sBiases (right)"  
        % ( 
            convert_old_exptname_to_manuscript_name(exptlist[-1]),
            convert_old_exptname_to_manuscript_name(exptlist[-2]),
            convert_old_exptname_to_manuscript_name(exptlist[-1])
          ),
          linespacing=1.5,
          fontsize=11.5
  ...
  plt.savefig('figs/norm_metrics_%s_vs_%s.pdf' % (convert_old_exptname_to_manuscript_name(exptlist[-2]), convert_old_exptname_to_manuscript_name(exptlist[-1])))
  plt.close()
